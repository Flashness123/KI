...
%adj0(X,Y) :- member((X, Y),[(0,1),(1,2),(2,3),(1,6),(6,7),(6,11),(11,10),(10,5),(10,15),(15,20),(15,16),(16,21),(21,22),(22,23),
%                   (23,24),(24,19),(19,14),(19,18),(18,13),(22,17),(17,12),(12,13),(13,8),(8,9),(9,4)]).
...
%                          (6,14)]).
idfs(StartNode, Goal, Limit, MaxLimit, Path) 
        :- dfs(StartNode,Goal, Limit, [StartNode], Path);
        MaxLimit \== Limit,
        NewLimit is Limit + 1,
        idfs(StartNode, Goal, NewLimit, MaxLimit, Path).

dfs(Node, Goal, DepthRemaining, Visited, Path)
        :- Goal == Node, reverse(Visited, Path);
